            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['route' => ['vehicles.fuelings.store', $vehicle->id]]) }}
                        ...
                        <div class="row mt-5">
                            <div class="col-sm-3">{{ Form::submit('Add fueling', array('class' => 'btn btn-primary float-left')) }}</div>
                            <div class="col-sm-9"><a class="btn btn-link text-secondary" href="{{ route('vehicles.fuelings.index', $vehicle->id) }}">Cancel creation</a></div>
                        </div>
